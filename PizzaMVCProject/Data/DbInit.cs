...
namespace PizzaMVCProject.Data
{
    public class DbInit
    {
        ...
        BEGIN TRANSACTION 
                ...
                values (@pizzaCategoryId, CONCAT('/productFiles/','pizza.jpg'), CONCAT('Pizza - ', @i), CONCAT('So tasty pizza - ', @i), 
                ...
                BEGIN
                insert into Products (CategoryId, Image, Name, Description, Brand, Calories, Weight, Price, DateOfPublication, Type)
                values (@saladCategoryId, CONCAT('/productFiles/','salad.jpg'), CONCAT('Salad - ', @i), CONCAT('Ooo`h so good salad - ', @i), 
